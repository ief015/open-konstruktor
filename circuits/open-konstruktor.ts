...
const openkonstruktor: Record<LevelNames, CircuitSimulationFactoryEntry> = {
  '': {
    pinRows: 6,
    height: 0,
    setup: (network) => {
  ...
  'DUAL INVERTER GATE': {
    ...
    height: 0,
    setup: (network) => {
      const [pinVCC0, pinVCC1, pinA0, pinY1, pinY0, pinA1, pinVCC2, pinVCC3] =
        network.getPinNodes();
      pinA0.label = 'A0';
      pinA1.label = 'A1';
      pinY0.label = 'Y0';
  ...
  '2-INPUT AND GATE': {
    ...
    height: 0,
    setup: (network) => {
      const [pinVCC0, pinVCC1, pinA, pinNC0, pinB, pinY, pinVCC2, pinVCC3] =
        network.getPinNodes();
      pinA.label = 'A';
      pinB.label = 'B';
      pinY.label = 'Y';
  ...
  '2-INPUT AND/NAND GATE': {
    ...
    height: 0,
    setup: (network) => {
      const [pinVCC0, pinVCC1, pinA, pinY, pinB, pinYN, pinVCC2, pinVCC3] =
        network.getPinNodes();
      pinA.label = 'A';
      pinB.label = 'B';
      pinY.label = 'Y';
  ...
  '4-INPUT AND-OR GATE': {
    setup: (network) => {
      ...
      assignVCC(pinVCC0, pinVCC1, pinVCC2, pinVCC3);
      const sim = new CircuitSimulation(network, 280);
      const seqA = new Sequence().repeatTogglePoints(10, 4, 30, [0, 10, 40]);
      const seqB = new Sequence().repeatTogglePoints(20, 4, 20, [0, 20, 40]);
      const seqC = new Sequence().repeatTogglePoints(10, 4, 30, [0, 20, 40]);
      const seqD = new Sequence().repeatTogglePoints(20, 4, 30, [0, 20, 30]);
      sim.setInputSequence(pinA, seqA);
      sim.setInputSequence(pinB, seqB);
  ...
  '4-BIT PARITY CHECKER': {
    setup: (network) => {
      ...
      assignVCC(pinVCC0, pinVCC1, pinVCC2, pinVCC3);
      const sim = new CircuitSimulation(network, 280);
      const seqD0 = new Sequence().repeatTogglePoints(10, 4, 30, [0, 10, 40]);
      const seqD1 = new Sequence().repeatTogglePoints(20, 4, 20, [0, 20, 40]);
      const seqD2 = new Sequence().repeatTogglePoints(10, 4, 30, [0, 20, 40]);
      const seqD3 = new Sequence().repeatTogglePoints(20, 4, 30, [0, 20, 30]);
  ...
  'ONE-HOT DETECTOR': {
    setup: (network) => {
      ...
      const sim = new CircuitSimulation(network, 280);
      const seqD0 = new Sequence().repeatTogglePoints(10, 4, 30, [0, 10, 40]);
      const seqD1 = new Sequence().repeatTogglePoints(20, 4, 20, [0, 30, 40]);
  ...
  'DUAL 2-INPUT CLOCKED AND GATE': {
    setup: (network) => {
      ...
      const seqA0 = new Sequence().repeatTogglePoints(10, 4, 30, [0, 10, 40]);
      const seqB0 = new Sequence().repeatTogglePoints(20, 4, 20, [0, 20, 40]);
      const seqA1 = new Sequence().repeatTogglePoints(20, 4, 30, [0, 20, 40]);
      const seqB1 = new Sequence().repeatTogglePoints(20, 4, 30, [0, 20, 30]);
      ...
      const [seqXL0, seqX0, seqXG0, seqXL1, seqX1, seqXG1] =
        createSequencesFromInputs(
          ...
          ({ inputs }) => {
            ...
            return [a0 < b0, a0 === b0, a0 > b0, a1 < b1, a1 === b1, a1 > b1];
          },
        );
