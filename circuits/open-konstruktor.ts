...
type LevelNames =
  ...
  // | 'OM1DL1 DUAL D LATCH' // TODO
  // | 'OM2JL1 DUAL J-K LATCH' // TODO
  | '' // TODO // usage of latches (shift register?)
  // | 'OM1SRF1 DUAL S-R FLIP-FLOP' // TODO
  // | 'OM1TF1 DUAL T FLIP-FLOP' // TODO
  ...
  | '' // TODO
  | '' // TODO
  // | '40 OD7S1 7-SEGMENT DISPLAY' // TODO
...
const openkonstruktor: CircuitSimulationFactories = {
  category: 'Open-Konstruktor',
  children: [
    {
      category: '01 - 10',
      items: [
        {
          key: '01 DUAL INVERTER GATE',
          label: '01 - DUAL INVERTER GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
            ...
            const seqA0 = new Sequence().repeatTogglePoints(
              10,
              3,
              0,
              [10, 20, 50, 80],
            );
            const seqA1 = new Sequence().repeatTogglePoints(
              20,
              4,
              0,
              [10, 30, 50, 60],
        ...
        {
          key: '02 2-INPUT AND GATE',
          label: '02 - 2-INPUT AND GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
        ...
        {
          key: '03 2-INPUT NAND GATE',
          label: '03 - 2-INPUT NAND GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
        ...
        {
          key: '04 2-INPUT OR GATE',
          label: '04 - 2-INPUT OR GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
        ...
        {
          key: '05 2-INPUT AND/NAND GATE',
          label: '05 - 2-INPUT AND/NAND GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
        ...
        {
          key: '06 2-INPUT OR/NOR GATE',
          label: '06 - 2-INPUT OR/NOR GATE',
          pinRows: 4,
          height: 0,
          setup: (network) => {
            const [
        ...
        {
          key: '10 4-INPUT AND-OR GATE',
          label: '10 - 4-INPUT AND-OR GATE',
          setup: (network) => {
            const [
              pinVCC0,
              pinVCC1,
            ...
            const seqB = new Sequence().repeatTogglePoints(
              20,
              4,
              20,
              [0, 20, 40],
            );
            const seqC = new Sequence().repeatTogglePoints(
              10,
              4,
              30,
              [0, 20, 40],
            );
            const seqD = new Sequence().repeatTogglePoints(
              20,
              4,
              30,
              [0, 20, 30],
    ...
    { category: '11 - 20', items: [] },
    {
      category: '21 - 30',
      items: [
        {
          key: '29 OM2JF1 DUAL J-K FLIP-FLOP',
          label: '29 - OM2JF1 DUAL J-K FLIP-FLOP',
          regenOnLoop: true,
          pinRows: 6,
          height: 0,
          setup: (network) => {
            ...
            const [seqQ0, seqQ1] = createSequencesFromInputs(
              ...
              ({
                inputs: [j0, j1, k0, k1, clk],
                edges: [d_j0, d_j1, d_k0, d_k1, d_clk],
                state,
              }) => {
                if (d_clk > 0) {
                  if (j0 && !k0) {
        ...
        {
          key: '30 OM1SRAM1 SRAM CELL',
          label: '30 - OM1SRAM1 SRAM CELL',
          regenOnLoop: true,
          setup: (network) => {
            const [
              pinVCC0,
    ...
    },
    {
      ...
      items: [
        {
          key: '31 4-BIT PARITY CHECKER',
          label: '31 - 4-BIT PARITY CHECKER',
          setup: (network) => {
            const [
              pinVCC0,
              pinVCC1,
            ...
            assignVCC(pinVCC0, pinVCC1, pinVCC2, pinVCC3);
            const sim = new CircuitSimulation(network, 280);
            const seqD0 = new Sequence().repeatTogglePoints(
              10,
              4,
              30,
              [0, 10, 40],
            );
            const seqD1 = new Sequence().repeatTogglePoints(
              20,
              4,
              20,
              [0, 20, 40],
            );
            const seqD2 = new Sequence().repeatTogglePoints(
              10,
              4,
              30,
              [0, 20, 40],
            );
            const seqD3 = new Sequence().repeatTogglePoints(
              20,
              4,
              30,
              [0, 20, 30],
            ...
            const [seqOP] = createSequencesFromInputs(
              ...
              ({ inputs: [a0, a1, a2, a3] }) => {
                const parity =
                  (Number(a0) + Number(a1) + Number(a2) + Number(a3)) % 2 === 1;
                return [parity];
              },
            );
        ...
        {
          key: '32 ONE-HOT DETECTOR',
          label: '32 - ONE-HOT DETECTOR',
          setup: (network) => {
            const [
              pinVCC0,
              pinVCC1,
        ...
        {
          key: '33 OC2C1 DUAL FULL COMPARATOR',
          label: '33 - OC2C1 DUAL FULL COMPARATOR',
          pinRows: 7,
          setup: (network) => {
            const [
              pinVCC0,
            ...
            assignVCC(pinVCC0, pinVCC1, pinVCC2, pinVCC3);
            const sim = new CircuitSimulation(network, 280);
            const seqA0 = new Sequence().addOscillation(10, 7, 20, 20);
            const seqB0 = new Sequence().addOscillation(20, 5, 30, 20);
            ...
            const [seqXL0, seqX0, seqXG0, seqXL1, seqX1, seqXG1] =
        ...
        {
          key: '36 DUAL 2-INPUT CLOCKED AND GATE',
          label: '36 - DUAL 2-INPUT CLOCKED AND GATE',
          setup: (network) => {
            const [
              pinVCC0,
              pinVCC1,
            ...
            const seqB0 = new Sequence().repeatTogglePoints(
              20,
              4,
              20,
              [0, 20, 40],
            ...
            const seqB1 = new Sequence().repeatTogglePoints(
              20,
              4,
              30,
              [0, 20, 30],
            ...
            const [seqY0, seqY1] = createSequencesFromInputs(
              ...
              ({
                inputs: [clk, a0, b0, a1, b1],
                edges: [d_clk, d_a0, d_b0, d_a1, d_b1],
                state,
              }) => {
                if (d_clk > 0) {
                  state.y0 = a0 && b0;
