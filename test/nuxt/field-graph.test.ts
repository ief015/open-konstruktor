...
test('KT221A-imported-vs-drawn', () => {
  ...
  for (const k in stringRecordings) {
    ...
    assertEqual(
      differences,
      0,
      `testCompareStringAndDrawing[${k}]:differences`,
    );
